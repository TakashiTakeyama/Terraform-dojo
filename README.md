...
- AWS でアプリ基盤を選ぶ: [AWS アプリケーション基盤の選定基準](docs/architecture/aws-application-platform-decision-guide.md)
- Web 配信・SSR のサービス選定: [AWS Web 配信・SSR の考え方](docs/architecture/aws-web-hosting-decision-guide.md)
